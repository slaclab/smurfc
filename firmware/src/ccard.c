...
// *****************************************************************************
// Taken from ccard.h
uint32_t tes_reset_port[NUM_TES_CHANNELS] = 
    {4,  6,  6,  4,  0,  5,  3,  3,  3,  3,  3,  3,  2,  0,  3,  0,  4};
uint32_t tes_reset_bit[NUM_TES_CHANNELS] =  
    {3,  13, 14, 0,  6,  0,  6,  4,  12, 11, 3,  9, 14, 15,  0,  4,  5};
